...
const Newsletter = () => {
  return (
    <section className="w-full px-32 lg:px-20 md:px-12 sm:px-8 xs:px-4 py-20 md:py-16 sm:py-14 xs:py-12 bg-[#F5F5F5]">
      ...
      <div className="flex lg:flex-row sm:flex-col justify-between gap-20 lg:items-center">
        {/* Image placeholder */}
        <motion.div
          className="w-[480px] h-[300px] md:w-[400px] md:h-[250px] sm:w-[320px] sm:h-[200px] xs:w-full xs:h-[180px] bg-gray-100 rounded-md"
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-4xl lg:text-[36px] md:text-[32px] sm:text-[28px] xs:text-[26px] font-light mb-6">Discovery Call</h3>
          <p className="text-lg text-gray-600 leading-relaxed mb-6">
            We start by listening — to your goals, your audience, and what’s
            been keeping you up at night. This sets the stage for everything to come.
          </p>
          <motion.div
          ...
          >
            <inputs
              ...
              className="flex-1 sm:w-full px-5 py-6 border border-primary text-base rounded-md outline-none focus:ring-2 focus:ring-primary"
            />
